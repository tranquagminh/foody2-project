    ...
    <AnimatedSection animation="fadeInUp" delay={0.1}>
        <div className="flex flex-col md:flex-row gap-10 max-w-4xl mx-auto">
            ...
            <div className="w-full md:w-1/2">
                ...
                <p className="text-xl font-semibold text-green-600 mb-8">{product.price.toLocaleString()}đ</p>
                ...
                <table className="w-full">
                    ...
                    <tr>
                        ...
                        <div className="flex gap-4">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 320 512">
