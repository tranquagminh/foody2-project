...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`hidden lg:block border-b border-[#d1d4da] px-12 transition-all duration-300 overflow-hidden ${
          isScrolled
      ...
      >
        <div className="flex gap-5 py-3.5">
          <small className="flex text-sm ">
            <FontAwesomeIcon
              icon={faMapMarkerAlt}
              className="w-4 h-4 me-2 self-center"
            />
          ...
          <div className="flex gap-3 flex-1 justify-end">
            ...
            <FontAwesomeIcon
              icon={faFacebook}
              className="w-4 h-4 ml-2 self-center cursor-pointer hover:text-[#3cb815] transition-colors"
            />
            <FontAwesomeIcon
              icon={faTwitter}
              className="w-4 h-4 ml-2 self-center cursor-pointer hover:text-[#3cb815] transition-colors"
      ...
      {/* Main navigation */}
      <nav
        className={`flex px-4 lg:px-12 transition-all duration-300 ${
